#ifndef QALIB_FDM_BARRIER_STEP_CONDITIONS
#define QALIB_FDM_BARRIER_STEP_CONDITIONS

#include <ql/methods/finitedifferences/stepconditions/all.hpp>
#include <ql/time/daycounter.hpp>

namespace QuantLib {
    class FdmDoubleBarrierCondition : public FdmSnapshotCondition {
      public:
        enum KnockType { In, Out };

      public:
        FdmDoubleBarrierCondition(const Time& t,
                                  ...
                                  const Array& vanillaValues = Array(0),
