...
#ifndef quantlib_mc_kiko_engines_hpp
#define quantlib_mc_kiko_engines_hpp
...
namespace QuantLib {
    ...
    */
    ...
    class MCKikoOptionEngine : public KikoOption::engine,
      ...
      public:
        ...
        // constructor
        MCKikoOptionEngine(ext::shared_ptr<GeneralizedBlackScholesProcess> process,
                           Size timeSteps,
        ...
        void calculate() const override {
            ...
            QL_REQUIRE(arguments_.kikobarrier_, "kiko barriers not given");
    ...
    template <class RNG = PseudoRandom, class S = Statistics>
    class MakeMCKikoOptionEngine {
      public:
        MakeMCKikoOptionEngine(ext::shared_ptr<GeneralizedBlackScholesProcess>);
        // named parameters
        MakeMCKikoOptionEngine& withSteps(Size steps);
        MakeMCKikoOptionEngine& withStepsPerYear(Size steps);
        MakeMCKikoOptionEngine& withBrownianBridge(bool b = true);
        MakeMCKikoOptionEngine& withAntitheticVariate(bool b = true);
        MakeMCKikoOptionEngine& withSamples(Size samples);
        MakeMCKikoOptionEngine& withAbsoluteTolerance(Real tolerance);
        MakeMCKikoOptionEngine& withMaxSamples(Size samples);
        MakeMCKikoOptionEngine& withBias(bool b = true);
        MakeMCKikoOptionEngine& withSeed(BigNatural seed);
    ...
    class KikoOptionPathPricer : public PathPricer<Path> {
      public:
        KikoOptionPathPricer(const ext::shared_ptr<KIKOBarrier> kikoBarrier,
                             Option::Type type,
                             Real strike,
      ...
      private:
        Real KItime(const ext::shared_ptr<BarrierBase>& KiBarrier, const Path& path) const;
        Real KOtime(const ext::shared_ptr<BarrierBase>& KoBarrier,
                    const Path& path,
    ...
    inline MCKikoOptionEngine<RNG, S>::MCKikoOptionEngine(
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>& MakeMCKikoOptionEngine<RNG, S>::withSteps(Size steps) {
        steps_ = steps;
        return *this;
    }

    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withStepsPerYear(Size steps) {
        stepsPerYear_ = steps;
        return *this;
    }
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withBrownianBridge(bool brownianBridge) {
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withAntitheticVariate(bool b) {
        antithetic_ = b;
        return *this;
    }
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withSamples(Size samples) {
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withAbsoluteTolerance(Real tolerance) {
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withMaxSamples(Size samples) {
        maxSamples_ = samples;
        return *this;
    }

    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>& MakeMCKikoOptionEngine<RNG, S>::withBias(bool biased) {
        biased_ = biased;
        return *this;
    }
    ...
    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>&
    MakeMCKikoOptionEngine<RNG, S>::withSeed(BigNatural seed) {
        seed_ = seed;
        return *this;
    }

    template <class RNG, class S>
    inline MakeMCKikoOptionEngine<RNG, S>::operator ext::shared_ptr<PricingEngine>() const {
        QL_REQUIRE(steps_ != Null<Size>() || stepsPerYear_ != Null<Size>(),
                   "number of steps not given");
        QL_REQUIRE(steps_ == Null<Size>() || stepsPerYear_ == Null<Size>(),
                   "number of steps overspecified");
        return ext::shared_ptr<PricingEngine>(new MCKikoOptionEngine<RNG, S>(
